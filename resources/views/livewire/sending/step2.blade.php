<div class="transition-all duration-3000 transform slide">
    <!-- component -->
            ...
            <div class="flex flex-wrap mx-3 mb-6">
                <div class="flex flex-col w-full h-auto px-3 mb-6">
                    <table class="table-auto">
                        <tbody>
                            <tr>
                                <td><input wire:model.ignore=options.size value="handCarry" type="radio"
                                        class="w-8 h-8 m-4 border-1 border-gray-400" />
                                </td>
                                <td class="flex flex-col"><label for="handCarry" class="text-lg tex-black">Fits in a
                                        pocket</label><span>Phone, keys, glasses etc.</span></td>
                                <td><svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="20.000000pt"
                            ...
                            <tr>
                                <td><input wire:model.ignore=options.size type="radio" value="byBag"
                                        class="w-8 h-8 m-4 border-1 border-gray-400" />
                                </td>
                                <td class="flex flex-col"><label for="byBag" class="text-lg tex-black">Fits in a
                                        bag</label><span>Laptop,
                                        book, clothes etc.</span></td>
                                <td><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="32"
                                        height="32px" viewBox="0 0 594.672 594.672"
                                        style="enable-background:new 0 0 594.672 594.672;" xml:space="preserve">
                                        <g>
                                            <g>
                            ...
                            <tr>
                                <td><input wire:model.ignore=options.size type="radio" value="byCar"
                                        class="w-8 h-8 m-4 border-1 border-gray-400" />
                                </td>
                            ...
                            <tr>
                                <td><input wire:model.ignore=options.size type="radio" value="byBigCar"
                                        class="w-8 h-8 m-4 border-1 border-gray-400" />
                                </td>
                                ...
                                <td><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="40" height="40px"
                            ...
                            <tr>
                                <td><input wire:model.ignore=options.size type="radio" value="byVan"
                                        class="w-8 h-8 m-4 border-1 border-gray-400" />
                                </td>
                                ...
                                <td><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="45"
                                        height="45px" viewBox="0 0 31.224 31.224"
                                        style="enable-background:new 0 0 31.224 31.224;" xml:space="preserve">
