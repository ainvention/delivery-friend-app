<x-guest-layout>
    <div class="invisible md:visible">
        <div class="flex flex-col m-auto mt-20 justify-center space-y-4">
            <span class="text-gray-900 uppercase text-6xl md:text-6xl font-bold mx-4 text-center">Send hva som helst,
                hvor
                som helst,
                når som helst.</span>
        </div>
    ...
    <div class="flex flex-col md:flex-row">
        <div class="flex flex-col w-full md:w-1/2 mx-4 md:mx-10 mb-20 space-y-10">
            <a href="/companies">
                <button
                    class="w-full text-2xl md:text-5xl font-bold leading-snug bg-green-400 rounded-2xl px-6 hover:bg-black hover:text-white">Frakt
                    for
        ...
        <div class="flex flex-col w-full md:w-1/2 mx-4 md:mx-10 space-y-10">
            <a href="/individuals">
                <button
                    class="w-full text-2xl md:text-5xl font-bold leading-snug bg-blue-400 rounded-2xl px-6 hover:bg-black hover:text-white">Og
                    for
                    private<span class="mx-2 hover:bg-black hover:text-white">@icon('chevron-right
                        ')</span>
                </button>
            </a>
            <span class="text-3xl font-medium">Du kan være sikker på at du alltid vil få tak i en som kan levere varene
